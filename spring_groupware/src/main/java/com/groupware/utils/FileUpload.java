...
import com.groupware.exception.EmptyMultipartFileException;
import com.groupware.exception.OverflowFileSizeException;


public class FileUpload {
	
	//경로 유동
	public static String uploadFile(MultipartFile image, String uploadPath)
													throws Exception{
...
//		
	...
	//경로 고정
	public static File saveFile(MultipartFile image, String uploadPath)
