...
<% 
	//spring security에 의한 로그인 리다이렉트를 ajax에서 인지하기 위해 설정. 
...
<link rel="shortcut icon" href="<%=request.getContextPath() %>/resources/common/images/favicon.ico">
...
<form id="loginForm" action="loginPost" method="POST" onsubmit="return validateForm();">
										...
										<fieldset>
											<label class="block clearfix">
												<span class="block input-icon input-icon-right">
													<input id="id" name="id" tabindex="1" onkeyup="this.value=this.value.replace(/[\ㄱ-ㅎㅏ-ㅣ가-힣]/g, &#39;&#39;);" style="ime-mode:disabled;" placeholder="ID" class="form-control" type="text" value="mimi"/>
												</span>
											</label>
											<label class="block clearfix">
												<span class="block input-icon input-icon-right">
													<input id="pwd" name="pwd" tabindex="2" placeholder="Password" class="form-control" type="password" value="mimi"/>
												</span>
											</label>
											<div class="space"></div>
											<div class="clearfix">
